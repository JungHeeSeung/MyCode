...
void CGameFramework::CreateSwapChain()
{
	...
	HRESULT hResult = m_pdxgiFactory->CreateSwapChain(m_pd3dCommandQueue, &dxgiSwapChainDesc, (IDXGISwapChain **)&m_pdxgiSwapChain); m_nSwapChainBufferIndex = m_pdxgiSwapChain->GetCurrentBackBufferIndex();
...
void CGameFramework::ChangeSwapChainState()
{
	...
	dxgiTargetParameters.Width = m_nWndClientWidth; dxgiTargetParameters.Height = m_nWndClientHeight;
